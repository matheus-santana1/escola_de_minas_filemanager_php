...
//Application Title
define('APP_TITLE', 'Escola de Minas');
...
$favicon_path = 'sources/favicon.png';
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <img src="./sources/logoEM2016.versão.eletrônica.jpg">
                                        </div>
...
class FM_Zipper_Tar
{
    ...
    {
        if (!$this->tar) {
            // Se $this->tar não estiver inicializado, retorne falso ou trate o erro
                    return false;
        }
...
<head>
    ...
    <style>
        body.fm-login-page{ background-color:#f7f9fb;font-size:14px;background-color:#4d5d71;}
